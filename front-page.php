	...
	<div id="content"><!-- #content -->
        <div class="container">
          <section class="who-am-i py-5" id="about">
            ...
            <p class="text-justify">Nomadic son of United States Marine and Kyokushinkai Practicioner. Descendant of the Bloodline of Ing. A true chosen brave. Shamanic seer, shadow walker, ancient sword seller, protector, gardener, and model for the fearsome and fearless.</p>
            <h2 class="signiture text-right">Signiture</h2>
          </section>
        </div>
         <section class="what-i-do py-5">
            <div class="container text-center">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="what-i-do__item mb-0">
